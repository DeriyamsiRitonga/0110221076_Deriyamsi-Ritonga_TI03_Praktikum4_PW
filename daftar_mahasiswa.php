...
<html lang="en">
  <head>
    ...
    <title>Daftar Mahasiswa - Deri</title>
  </head>
  <body>
  ...
  $mahasiswa1 = new Mahasiswa("0110221075", "Adzhimatinur Azzahra", 2021, "TI", 3.96);
  $mahasiswa2 = new Mahasiswa("0110221081", "Anggi Novita Sari", 2021, "TI", 4.0);
  $mahasiswa3 = new Mahasiswa("0110221076", "Deriyamsi Ritonga", 2021, "TI", 3.96);
  $mahasiswa4 = new Mahasiswa("0110221078", "Farida Afrina", 2021, "TI", 4.0);
  $mahasiswa5 = new Mahasiswa("0110221078", "Seri Ani Ritonga", 2021, "TI", 4.0);
  $mahasiswa6 = new Mahasiswa("0110221073", "Yulia Ananda Siregar", 2021, "TI", 3.96);
